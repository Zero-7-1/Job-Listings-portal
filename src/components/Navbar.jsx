...
const Navbar = () => {
  ...
  const linkClass = ({ isActive }) => 
    isActive ? 'text-white bg-green-500 hover:bg-green-700 hover:text-white rounded-md px-3 py-2' 
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            <NavLink className="flex flex-shrink-0 items-center mr-4" to="/">
              <img
                ...
                alt="Jobs"
              />
              <span className="hidden md:block text-white text-2xl font-bold ml-2">Job hunt here !</span>
            </NavLink>
